...
from clearervoice48k.dataloader.dataloader import DataReader
from clearervoice48k.utils.decode import decode_one_audio
...
class CLS_MossFormer2_SE_48K(SpeechModel):
    ...
    def __init__(self, args):
        ...
        from clearervoice48k.models.mossformer2_se.mossformer2_se_wrapper import \
            MossFormer2_SE_48K
...
class CLS_MossFormer2_SR_48K(SpeechModel):
    ...
    def __init__(self, args):
        ...
        # Import the MossFormer2 speech enhancement model for 48 kHz
        from clearervoice48k.models.mossformer2_sr.mossformer2_sr_wrapper import \
            MossFormer2_SR_48K
